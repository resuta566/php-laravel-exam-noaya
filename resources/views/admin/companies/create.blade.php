...
@section('pageTitle', 'Create New Company')
@section('content')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3>{{ __('Create New Companies') }}</h3>
                </div>

                <div class="card-body">      
                    <form method="POST" action="{{ route('companies.store') }}" enctype="multipart/form-data" class="form-horizontal form-material">
                        @csrf
